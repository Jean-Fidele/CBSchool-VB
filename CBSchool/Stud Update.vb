...
Public Class Stud_Update
    ...
    Private Sub Stud_Update_FormClosed(ByVal sender As Object, ByVal e As FormClosedEventArgs) Handles Me.FormClosed
        cn.Close()
    End Sub
    Private Sub Stud_Update_Load(ByVal sender As Object, ByVal e As EventArgs) Handles MyBase.Load
        ds.Clear()
        ph = 1
    ...
    Private Sub TextBox14_KeyPress(ByVal sender As Object, ByVal e As KeyPressEventArgs) Handles TextBox14.KeyPress
    ...
    Private Sub TextBox14_TextChanged(ByVal sender As Object, ByVal e As EventArgs) Handles TextBox14.TextChanged
